            ...
            <div className="relative">
              ...
              {financesOpen && (
                <div className="absolute top-full left-0 mt-2 w-72 bg-white rounded-lg shadow-xl py-2 border border-gray-200">
                  ...
                  <Link href="/admin/finances/contrats" onClick={closeAllMenus} className="block px-4 py-2 text-sm text-gray-900 hover:bg-blue-50 hover:text-blue-600">
                    🔄 Contrats Récurrents ⭐
                  </Link>
                  <div className="border-t border-gray-200 my-1"></div>
              ...
              {isAdmin && (
                <>
                  ...
                  <div className="border-t pt-2 mt-2">
                    ...
                    <Link href="/admin/finances/contrats" onClick={closeMobileMenu} className="block py-2 px-4 text-sm text-gray-700 hover:bg-blue-50 rounded-lg">
                      🔄 Contrats Récurrents ⭐
                    </Link>
