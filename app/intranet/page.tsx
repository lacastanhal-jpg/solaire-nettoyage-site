...
export default function LoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    const users = {
      'jerome@solairenettoyage.fr': { name: 'Jérôme Gely', role: 'admin' },
      'axel@solairenettoyage.fr': { name: 'Axel', role: 'admin' },
      'sebastien@solairenettoyage.fr': { name: 'Sébastien', role: 'employee' },
      'joffrey@solairenettoyage.fr': { name: 'Joffrey', role: 'employee' },
      'fabien@solairenettoyage.fr': { name: 'Fabien', role: 'employee' },
      'angelo@solairenettoyage.fr': { name: 'Angelo', role: 'employee' }
    }
    
    const user = users[email as keyof typeof users]
    
    if (user && password === 'solaire2024') {
