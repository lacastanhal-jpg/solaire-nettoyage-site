...
export default function Ombrieres() {
  const [selectedImage, setSelectedImage] = useState<string | null>(null)

  const images = [
    '/images/services/ombrieres/ombrieres-1.jpg',
    '/images/services/ombrieres/ombrieres-2.jpg',
    '/images/services/ombrieres/ombrieres-3.jpg',
    '/images/services/ombrieres/ombrieres-4.jpg',
    '/images/services/ombrieres/ombrieres-5.jpg',
    '/images/services/ombrieres/ombrieres-6.jpg',
  ]

  const features = [
    'Intervention hors heures d\'ouverture',
    'Matériel compact adapté aux parkings',
    'Balisage zone de sécurité',
    'Nettoyage rapide et efficace',
    'Planning flexible',
    'Minimum de gêne pour les clients'
  ]

  const specs = [
    { label: 'Horaires', value: 'Nuit & weekend' },
    { label: 'Rapidité', value: 'Jusqu\'à 3000m²/h' },
    { label: 'Secteurs', value: 'Toute France' },
    { label: 'Expérience', value: '1000+ sites' }
  ]
    ...
    <main className="bg-dark-bg pt-24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="font-display text-5xl md:text-6xl font-bold text-white mb-6">
              Nettoyage Ombrières de Parking
            </h1>
            <p className="text-xl text-gray-300 leading-relaxed">
              Spécialistes du nettoyage d'ombrières photovoltaïques pour supermarchés et zones commerciales. 
              Interventions adaptées à votre activité avec minimum de perturbation.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-20">
            <h2 className="text-3xl font-bold text-white mb-8">Notre approche</h2>
          ...
          <div className="mb-20 bg-dark-surface border border-white/8 p-8">
            <h3 className="text-2xl font-bold text-white mb-6">Nos atouts</h3>
          ...
          <div className="bg-navy p-12 text-center">
            <h2 className="text-3xl font-bold text-white mb-4">
              Nettoyage d'ombrières pour votre site ?
            </h2>
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Intervention adaptée à votre planning et devis gratuit sous 24h.
            </p>
