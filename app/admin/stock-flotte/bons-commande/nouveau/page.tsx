...
import { Plus, Trash2, AlertCircle, Save, Calculator } from 'lucide-react'
...
export default function NouveauBonCommandePage() {
  ...
  const [statut, setStatut] = useState<'brouillon' | 'envoye'>('brouillon')
  ...
  const [modeCalculAuto, setModeCalculAuto] = useState(true)
  ...
  async function loadData() {
    try {
      setLoadingData(true)
      const [numeroGenere, fournisseursData, articlesData] = await Promise.all([
        genererNumeroBonCommande(),
        getAllFournisseurs(),
        getAllArticlesStock()
      ])
      
      setNumero(numeroGenere)
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const bonData = {
        ...
        notes,
        totalEstime,
        createdBy: 'Jerome GELY' // TODO: récupérer depuis auth
      }

      const id = await createBonCommandeFournisseur(bonData)
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold text-gray-900">📝 Nouveau Bon de Commande</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 font-mono font-bold"
                required
                disabled
              />
            </div>
        ...
        <div className="bg-white rounded-lg shadow-lg border-2 border-blue-200 p-6">
          ...
          {lignes.length === 0 ? (
            <div className="text-center py-12 bg-gray-50 rounded-lg">
              ...
              <p className="text-sm text-gray-500 mt-2">Recherchez et ajoutez des articles ci-dessus</p>
            </div>
          ) : (
        ...
        <div className="flex gap-4">
          ...
          <Link
            ...
            className="px-8 py-4 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 font-bold text-lg text-center"
          >
            Annuler
          </Link>
        </div>
