...
export default function ModifierInterventionAdminPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    statut: 'Planifiée' as InterventionCalendar['statut'],
    notes: ''
  })
  ...
  const loadData = async () => {
    try {
      setLoading(true)
      const [interventionsData, sitesData, clientsData, groupesData, equipesData] = await Promise.all([
        getAllInterventionsCalendar(),
        getAllSitesComplet(),
        getAllClients(),
        getAllGroupes(),
      ...
      const inter = interventionsData.find(i => i.id === interventionId)
      ...
      setSelectedGroupeId(inter.groupeId || '')
      setSelectedClientId(inter.clientId)
      setSelectedSiteId(inter.siteId)
      setSelectedEquipeId(inter.equipeId)
      setFormData({
        dateDebut: inter.dateDebut,
        dateFin: inter.dateFin,
        heureDebut: inter.heureDebut,
        heureFin: inter.heureFin,
        type: inter.type,
        statut: inter.statut,
        notes: inter.notes || ''
      })
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await updateInterventionCalendar(interventionId, {
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-blue-900">Modifier Intervention</h1>
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-3 pt-4">
              <button
                ...
                onClick={handleSave}
                disabled={saving}
                className="flex-1 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold py-4 px-6 rounded-lg transition-all disabled:opacity-50"
              >
