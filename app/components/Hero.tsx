    ...
    <section className="mt-[77px] bg-gradient-to-br from-blue-600 to-blue-400 relative">
      <div className="max-w-[1400px] mx-auto px-12 py-32 pb-24">
        ...
        <div className="flex gap-4 items-center">
          ...
          <a href="tel:+33632134766" className="bg-white text-blue-900 px-10 py-4 text-base font-semibold hover:bg-[#fbbf24] transition-all hover:-translate-y-0.5 inline-block">
            06 32 13 47 66
          </a>
