...
import { getDocumentsBySociete, deleteDocument } from '@/lib/firebase/documents'
...
export default function DocumentsList({ societe, onDocumentClick }) {
  ...
  const totalTTC = filteredDocuments.reduce((sum, doc) => sum + (doc.montantTTC || 0), 0)
